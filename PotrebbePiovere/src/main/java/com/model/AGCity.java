...
import com.agstats.FilteredWeatherStat;
import com.agstats.Stats;
import com.agstats.WeatherStats;
...
public class AGCity {
	 ...
	 */
	public AGCity(long id) throws CurrentWeatherException{
		this.id=id;
	 ...
	 * @throws CurrentWeatherException eccezione in caso di id non valido o dati storici non presenti
	 */
	public AGCity(long id, long from, long to) throws CurrentWeatherException{
		this.id=id;
		this.historicWeather = new ArrayList<CurrentWeather>();
		this.dataLoad();
